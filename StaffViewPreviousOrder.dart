...
class _PreviousOredrPageState extends State<PreviousOredrPage> {
  ...
  Future<List<ViewPreviousOrder>> _getNames() async {
    ...
    for (var nn in jsonData["data"]) {
      ...
      ViewPreviousOrder(nn["naame"].toString(),nn["phone"].toString(),nn["place"].toString(),nn["post"].toString(),nn["pin"].toString(),nn["product_name"].toString(),nn["qty"].toString(),nn["price"].toString(),nn["assign_id"].toString());
      clist.add(newname);
    }
    return clist;
  }
...
class ViewPreviousOrder {
  ...
  ViewPreviousOrder(this.naame,this.phone,this.place,this.post,this.pin,this.product_name,this.qty,this.price,this.assign_id);
}
